...
//	var $host='115.68.24.163';
	...
	function sshclient($host='127.0.0.1', $port=5135, $identity='id_rsa', $user='root')
	{
		...
		if($ssh_debug_on==true) {
			$this->ssh_config  = " -vvvvvv -o ConnectTimeOut=10  -vv -o Port=$this->port -o IdentityFile=$this->base/$this->IdentityFile ";
			...
			$this->ssh_config  = " -vvvvvv -o ConnectTimeOut=10 -o Port=$this->port -o IdentityFile=$this->base/$this->IdentityFile ";
